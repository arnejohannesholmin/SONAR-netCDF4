...
s|Variables | |
 |#{var}string single_target_detection_algorithm(ping_time,beam)# |#MA# |#The name of the algorithm used for the single target detecion. Supported algorithms, for which parameters are defined in the single_target subgroup of the beam group, are "" and "".#
